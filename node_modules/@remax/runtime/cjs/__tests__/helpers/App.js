...
var App = /** @class */ (function () {
    ...
    App.prototype.unhandledRejection = function () {
        this.config.onUnhandledRejection();
    };
    App.prototype.pageNotFound = function () {
        this.config.onPageNotFound({
            path: 'path',
        });
    };
    App.prototype.shareAppMessage = function () {
...
function AppConstructor(config) {
    var app = new App(config);
    return app;
}
exports.default = AppConstructor;

...
var alias_1 = __importDefault(require("./props/alias"));
var Textarea = /** @class */ (function (_super) {
    ...
    Textarea.prototype.render = function () {
        var _a, _b, _c, _d, _e;
        var inputProps = __assign(__assign({}, this.props), { onInput: createHostComponent_1.createCallback(this.handleInput, createHostComponent_1.createInputEvent) });
        if (inputProps.onConfirm) {
            inputProps.onConfirm = createHostComponent_1.createCallback(this.props.onConfirm, createHostComponent_1.createInputEvent);
        }
        if (inputProps.onFocus) {
            inputProps.onFocus = createHostComponent_1.createCallback(this.props.onFocus, createHostComponent_1.createInputEvent);
        }
        if (inputProps.onBlur) {
            inputProps.onBlur = createHostComponent_1.createCallback(this.props.onBlur, createHostComponent_1.createInputEvent);
        }
        ...
        var nextProps = createHostComponent_1.aliasProps(__assign(__assign({}, inputProps), this.state), alias_1.default);

...
var Input = function (props, ref) {
    ...
    return (React.createElement("input", __assign({}, restProps, { ref: ref, type: inputType, onKeyPress: handleKeyPress, className: clsx('remax-input', className, placeholderStyleClassName) })));
};

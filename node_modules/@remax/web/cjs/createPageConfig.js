...
var PullToRefresh_1 = __importDefault(require("./PullToRefresh"));
...
function createPageConfig(Page, name) {
    ...
    return /** @class */ (function (_super) {
        ...
        function PageConfig(props) {
            ...
            _this.title = _this.props.pageConfig.defaultTitle || document.title;
            ...
            _this.handleRefresh = function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, page.callLifecycle(framework_shared_1.Lifecycle.pullDownRefresh)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 4];
                        case 3:
        ...
        PageConfig.prototype.render = function () {
            var _a = this.props, tabBar = _a.tabBar, location = _a.location;
            var refreshing = this.state.refreshing;
            var hasTabBar = !!tabBar;

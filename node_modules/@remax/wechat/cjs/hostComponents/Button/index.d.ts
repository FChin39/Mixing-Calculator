...
export interface ButtonProps extends BaseProps {
     ...
     */
    openType?: 'contact' | 'share' | 'getPhoneNumber' | 'getUserInfo' | 'launchApp' | 'openSetting' | 'feedback' | 'openGroupProfile' | 'addFriend' | 'addColorSign' | 'openPublicProfile' | 'addGroupApp' | 'shareMessageToFriend' | 'addToFavorites';
    /**
     * 1.0.0
